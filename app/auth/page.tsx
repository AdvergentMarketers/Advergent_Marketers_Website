...
export default function AuthPage() {
  ...
  const handleAuth = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setIsLoading(false); // Only stop loading spinner if it fails
    }
  };
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-white px-4 sm:px-6 lg:px-8">
      <FadeIn className="w-full max-w-md space-y-8">
        ...
        <div className="mt-8">
          <button type="button" className="w-full flex items-center justify-center px-4 py-3 border border-matteBlack/20 rounded-md shadow-sm bg-white text-sm font-semibold text-matteBlack hover:bg-offWhite transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-matteBlack opacity-50 cursor-not-allowed">
